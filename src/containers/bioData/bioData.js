            ...
            <MDBContainer className="mt-4">
                <MDBCard>
                    <MDBCardBody>
                        ...
                        <MDBRow>
                            <MDBCol>
                                <MDBInput type="date" name="dob" onChange={this.valueChangeHandler}
                                          label="Date of birth"
                        ...
                        <MDBRow>
                            <MDBCol>
                                <MDBInput type="textarea" label="Address" rows="2" name="address"
                                          value={this.state.address} onChange={this.valueChangeHandler}/>
                            </MDBCol>
                        </MDBRow>
                        <MDBRow>
                            <MDBCol>
