...
import {
    MDBBtn, MDBModal, MDBModalHeader, MDBModalBody, MDBModalFooter, MDBInput,
    MDBCard, MDBCardBody, MDBCardHeader, MDBTable, MDBTableHead, MDBTableBody
} from 'mdbreact'
            ...
            <>
                <MDBModal isOpen={this.state.toggleModal}>
                    <form onSubmit={this.state.updateFlag ? this.updateHandler.bind(this) : this.addHandler.bind(this)}>
                        ...
                        <MDBModalBody>
                            <MDBInput required minLength={5} readOnly={this.state.viewFlag} label="Title" type="text"
                                      name="title" value={this.state.note.title}
                                      onChange={this.changeHandler.bind(this)}/>
                            <MDBInput required readOnly={this.state.viewFlag} label="Body" type="textarea" rows="3"
                                      name="body" value={this.state.note.body}
                                      onChange={this.changeHandler.bind(this)}/>
                        </MDBModalBody>
                        <MDBModalFooter>
                            {
                                (this.state.viewFlag) ?
                                    <MDBBtn color="primary" onClick={this.toggleEdit.bind(this)}>Edit</MDBBtn> : null
                            }
